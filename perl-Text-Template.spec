...
%else
%bcond_with perl_Text_Template_enables_optional_test
%endif
...
# Not in Fedora
# BuildRequires:  %%{?scl_prefix}perl(Test::More::UTF8)
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 1.58-2
- SCL
